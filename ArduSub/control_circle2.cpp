...
bool Sub::circle2_init()
{
	...
	asv_destination.lat = 36.1623285;
	asv_destination.lng = 120.4910847;
	asv_destination.alt = 0.00;
	Vector3f asv_destination_neu;
	asv_destination_neu = wp_nav.asv_yaw_destination_trans(asv_destination);
	
    // initialise circle controller including setting the circle center based on vehicle speed
    circle_nav.init(asv_destination_neu);
